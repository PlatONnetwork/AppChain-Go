...
// LogStaked is a paid mutator transaction binding the contract method 0xf3e0eded.
//
// Solidity: function logStaked(address signer, bytes signerPubkey, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total, bytes blsPubkey) returns()
func (_Stakinginfo *StakinginfoTransactor) LogStaked(opts *bind.TransactOpts, signer common.Address, signerPubkey []byte, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int, blsPubkey []byte) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logStaked", signer, signerPubkey, validatorId, activationEpoch, amount, total, blsPubkey)
}

// LogStaked is a paid mutator transaction binding the contract method 0xf3e0eded.
//
// Solidity: function logStaked(address signer, bytes signerPubkey, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total, bytes blsPubkey) returns()
func (_Stakinginfo *StakinginfoSession) LogStaked(signer common.Address, signerPubkey []byte, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int, blsPubkey []byte) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, signer, signerPubkey, validatorId, activationEpoch, amount, total, blsPubkey)
}

// LogStaked is a paid mutator transaction binding the contract method 0xf3e0eded.
//
// Solidity: function logStaked(address signer, bytes signerPubkey, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total, bytes blsPubkey) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogStaked(signer common.Address, signerPubkey []byte, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int, blsPubkey []byte) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, signer, signerPubkey, validatorId, activationEpoch, amount, total, blsPubkey)
}
...
// FilterStaked is a free log retrieval operation binding the contract event 0xf888acdd10e77962cf1d0ce10382616f057711fa437e5413294303f2fd4c89dc.
//
// Solidity: event Staked(address indexed signer, uint256 indexed validatorId, uint256 nonce, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes signerPubkey, bytes blsPubkey)
...
// WatchStaked is a free log subscription operation binding the contract event 0xf888acdd10e77962cf1d0ce10382616f057711fa437e5413294303f2fd4c89dc.
//
// Solidity: event Staked(address indexed signer, uint256 indexed validatorId, uint256 nonce, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes signerPubkey, bytes blsPubkey)
...
// ParseStaked is a log parse operation binding the contract event 0xf888acdd10e77962cf1d0ce10382616f057711fa437e5413294303f2fd4c89dc.
//
// Solidity: event Staked(address indexed signer, uint256 indexed validatorId, uint256 nonce, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes signerPubkey, bytes blsPubkey)
