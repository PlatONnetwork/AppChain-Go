...
var (
	...
	authorsFileHeader = "# This is the official list of AppChain-Go authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The AppChain-Go Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The AppChain-Go library"
	}
	return "the AppChain-Go library"
}
