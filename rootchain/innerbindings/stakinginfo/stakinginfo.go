...
// LogStaked is a paid mutator transaction binding the contract method 0xcdc9ec13.
//
// Solidity: function logStaked(string desc, address[] addressList, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total, bytes pubkeys) returns()
func (_Stakinginfo *StakinginfoTransactor) LogStaked(opts *bind.TransactOpts, desc string, addressList []common.Address, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int, pubkeys []byte) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logStaked", desc, addressList, validatorId, activationEpoch, amount, total, pubkeys)
}

// LogStaked is a paid mutator transaction binding the contract method 0xcdc9ec13.
//
// Solidity: function logStaked(string desc, address[] addressList, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total, bytes pubkeys) returns()
func (_Stakinginfo *StakinginfoSession) LogStaked(desc string, addressList []common.Address, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int, pubkeys []byte) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, desc, addressList, validatorId, activationEpoch, amount, total, pubkeys)
}

// LogStaked is a paid mutator transaction binding the contract method 0xcdc9ec13.
//
// Solidity: function logStaked(string desc, address[] addressList, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total, bytes pubkeys) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogStaked(desc string, addressList []common.Address, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int, pubkeys []byte) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, desc, addressList, validatorId, activationEpoch, amount, total, pubkeys)
}
...
// FilterStaked is a free log retrieval operation binding the contract event 0x38936452df79cfce77c62ab7e139e4e42f515c1f1aa3d7a585bea83776b85532.
//
// Solidity: event Staked(address indexed signer, address owner, uint256 indexed validatorId, uint256 nonce, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes pubkeys, string desc)
...
// WatchStaked is a free log subscription operation binding the contract event 0x38936452df79cfce77c62ab7e139e4e42f515c1f1aa3d7a585bea83776b85532.
//
// Solidity: event Staked(address indexed signer, address owner, uint256 indexed validatorId, uint256 nonce, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes pubkeys, string desc)
...
// ParseStaked is a log parse operation binding the contract event 0x38936452df79cfce77c62ab7e139e4e42f515c1f1aa3d7a585bea83776b85532.
//
// Solidity: event Staked(address indexed signer, address owner, uint256 indexed validatorId, uint256 nonce, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes pubkeys, string desc)
